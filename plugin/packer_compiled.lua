...
_G.packer_plugins = {
  ...
  ["iceberg.vim"] = {
    loaded = true,
    path = "/Users/sean/.local/share/nvim/site/pack/packer/start/iceberg.vim",
    url = "https://github.com/cocopon/iceberg.vim"
  },
  ["lsp-status.nvim"] = {
    loaded = true,
    path = "/Users/sean/.local/share/nvim/site/pack/packer/start/lsp-status.nvim",
  ...
  ["tokyonight.nvim"] = {
    loaded = true,
    path = "/Users/sean/.local/share/nvim/site/pack/packer/start/tokyonight.nvim",
